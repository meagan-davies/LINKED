...
from .models import TestLinker,flexibility
...
def add_linker(request):
    ...
    if request.method=="POST":
        form1=LinkerForm(request.POST) #fill out the form and they are posted
        if form1.is_valid():
            form1.save()
    ...
    return render(request,'linkerform.html',{'form1':form1,'submitted':submitted})